 <?php  
    ...
    // build SQL statment
    $sql = "SELECT d1restTime, d2restTime, d3restTime, d4restTime, d5restTime, d6restTime, d7restTime, 
			       d8restTime, d9restTime, d10restTime, d11restTime, d12restTime, d13restTime, d14restTime"."
            FROM `sb_sprints2`".
